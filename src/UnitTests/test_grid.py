...
class Test_grid(unittest.TestCase):
    ...
    def test_if_the_grid_is_emtpy(self):
        self.gridempty=''
        self.assertFalse(False,self.grid.validate_values(self.gridempty))
    ...
    def test_if_grid_is_wrong(self):
        ...
        self.assertFalse(False,self.grid.validate_values(self.gridwrong))
    ...
    def test_if_grid_is_not_completed(self):
        ...
        self.assertFalse(False,self.grid.validate_values(self.not_completed_grid))
