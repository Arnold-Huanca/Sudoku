...
class Test_grid(unittest.TestCase):
    ...
    def test_if_the_grid_is_emtpy(self):
        self.gridempty=''
        self.assertFalse(False,self.grid.set_values(self.gridempty))
    ...
    def test_if_grid_is_wrong(self):
        ...
        self.assertFalse(False,self.grid.set_values(self.gridwrong))
    ...
    def test_if_grid_is_not_completed(self):
        ...
        self.assertFalse(False,self.grid.set_values(self.not_completed_grid))
                
        
    def test_if_set_values_inserts_correct_squares_easy_grid(self):
        'to verify if the grid values is inserting the value in correct square'
        grid1 = self.grid.set_values(self.gridA)
        self.assertEqual(self.grid_expected,grid1)
        print grid1
        self.grid.display(grid1)
